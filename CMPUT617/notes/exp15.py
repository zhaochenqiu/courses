...
W1 = Variable(torch.torch.FloatTensor(2, 3).uniform_(-1, 1), requires_grad=True)
b1 = Variable(torch.zeros((1, 3)), requires_grad=True)
W2 = Variable(torch.torch.FloatTensor(3, 1).uniform_(-1, 1), requires_grad=True)
