...
#    path_im = "D:\dataset\microscopy"
    ...
    pickle.dump(train_fs, open('train_fs.txt','wb'))
    pickle.dump(valid_fs, open('valid_fs.txt','wb'))
    pickle.dump(test_fs, open('test_fs.txt','wb'))


    train_fs = pickle.load(open('train_fs.txt','rb'))
    valid_fs = pickle.load(open('valid_fs.txt','rb'))
    test_fs = pickle.load(open('test_fs.txt','rb'))
    ...
    torch.save(model.state_dict(),"mic_network.pt")



    smodel = model = Net().to(device)
    smodel.load_state_dict(torch.load("mic_network.pt"))
