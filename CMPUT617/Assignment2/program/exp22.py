...
#     print("input_I", input_I.shape)
    ...
    data_J = input_J.unsqueeze(1)
    data_I = input_I.unsqueeze(1)

    input_data = torch.cat((data_J, data_I), 1)

#    input_data = input_data*(1/255)
...
#     print("input_data", input_data.shape)
    ...
    joint = sample_batch(input_data, 300)
    marginal = sample_batch(input_data, 300, sample_mode='marginal')
...
result_errors = ma(result_errors, 10)
