...
#    print(entry)
#    print(trainlist[0])
#    trainlist[0] = trainlist[2]
#    trainlist[0] = (torch.randn(1, 28, 28) + 0.5,torch.cuda.LongTensor(1) )
    ...
    for n in range(10):
        ...
        trainlist[n] = tuple(entry)

#    entry[0][0,0,0] = -0.1
#
#     print(entry[0][0,0,0])
#
#     trainlist[0] = tuple(entry)


#     print(trainlist[1][0].dtype)
#     print(trainlist[1][1].dtype)
#     print(trainlist[0][0].dtype)
#     print(trainlist[0][1].dtype)
...
#        trainlist[i] = (torch.zeros(1, 28, 28), 0)

    traindata = tuple(trainlist)
...
#     print(data1)
#
#     data1 = (torch.zeros(1, 28, 28), 1)
#
#     print(torch.zeros(1, 28,28) + 1)
#
#
#     listdata1 = list(data1)

#    for i in range(1000):
#        traindata[i] = (torch.zeros(1, 28, 28), 0)





# #    print(traindata.__getitem__(self, 0))
#     print(traindata.urls)
